...
Edit [`./scripts/head_camera_tracking.py`](./scripts/head_camera_tracking.py):
...
Please edit directories of cascade files in the script file.
...
```python
    def _detect_object(self, input_depth_image):
        ...
        # Detection range is separated to four level.
        # Unit: mm
        DETECTION_DEPTH = [
                (500, 700),
                (600, 800),
