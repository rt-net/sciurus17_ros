...
class GripperControl:
    ...
    def move_gripper_angle(self, gripper, joint_group_name, angle):
        ...
        plan_and_execute(
            self.sciurus17, gripper, self.logger,
...
def main(args=None):
    ...
    # 右グリッパを2回開閉する
    for _ in range(2):
        controller.move_gripper_angle(controller.r_gripper, 'r_gripper_group', R_GRIPPER_OPEN)
        controller.move_gripper_angle(controller.r_gripper, 'r_gripper_group', R_GRIPPER_CLOSE)

    # 左グリッパを2回開閉する
    for _ in range(2):
        controller.move_gripper_angle(controller.l_gripper, 'l_gripper_group', L_GRIPPER_OPEN)
        controller.move_gripper_angle(controller.l_gripper, 'l_gripper_group', L_GRIPPER_CLOSE)
